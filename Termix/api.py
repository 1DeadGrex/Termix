...
async def register_success(
    ...
    display_name = html_lib.escape(name) if name and name != "Unknown" else "Player"
    safe_steam_id = html_lib.escape(steam_id) if steam_id else "NOT-LINKED"
    safe_avatar = html_lib.escape(avatar, quote=True) if avatar else ""
                ...
                <div class="body">
                    ...
                    <div class="dossier">
                        ...
                        <div class="idrows">
                            ...
                            <div class="kv"><b>STEAM ID64</b><span class="idrow"><span class="val" id="sidVal">{safe_steam_id}</span><button class="mini" id="copyBtn" type="button">COPY</button></span></div>
